...
e = feedurl.entries[0]
threadurl = e.link
woot.send ("PRIVMSG #pson :Newest thread: %s\r\n" % newest)
woot.send ("PRIVMSG #pson :URL: %s\r\n" % threadurl)
...
sophosurl = d.link
woot.send ("PRIVMSG #pson :Newest security title: %s\r\n" % newestsophos)
woot.send ("PRIVMSG #pson :URL: %s\r\n" % sophosurl)
if data.find ( '!exploitdb' ) != -1:
feedurlex = feedparser.parse("https://twitter.com/statuses/user_timeline/234234.rss")
newestex = feedurlex['items'][0].title
woot.send ("PRIVMSG #pson :Latest exploit: %s\r\n" % newestex)
